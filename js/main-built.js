...
define('text!templates/video_item.html',[],function () { return '<div class=\'video<% if (active) { %> active<% } %>\' data-id="<%= id %>" data-video-id="<%= video_id %>">\n\t<p>\n\t\t<%= name %> by <%= user.username %> <%= user.first_name %>\n\t</p>\n</div>';});

define('views/video_item',[
	'jquery',
	'underscore',
	'backbone',
	'views/player',
